            ...
            <div className="container mx-auto flex h-16 md:h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/devis" className="hidden sm:block">
                        <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-white text-sm md:text-lg px-4 md:px-8 h-10 md:h-12 shadow-md hover:shadow-lg transition-all rounded-full">
                    ...
                    <nav className="container mx-auto px-4 py-4 space-y-2">
                        ...
                        <div className="pt-4 border-t border-slate-100">
                            <Link href="/devis" onClick={() => setMobileMenuOpen(false)}>
                                <Button className="w-full bg-teal-600 hover:bg-teal-700 text-white h-12 rounded-full">
