...
import { getClimateProfile, getEstimatedSavings, getHousingContext, getRegionalProfile } from "@/lib/climate-data";
...
export function ClimateZoneModule({ city }: ClimateZoneModuleProps) {
    ...
    const savings = getEstimatedSavings(city.population || 0);
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10">
                ...
                <div className="bg-gradient-to-br from-teal-50 to-cyan-50 p-6 rounded-2xl border border-teal-100">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h3 className="font-bold text-slate-800">Climat belge</h3>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-100">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500">Par rapport à une chaudière mazout/gaz</p>
                        </div>
                    </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                ...
                <div className="mt-4 pt-4 border-t border-slate-200">
                    <p className="text-sm text-slate-600">
                        <strong className="text-teal-700">Dimensionnement :</strong> {climate.dimensioning}
                    </p>
                </div>
            </div>
        </section>
