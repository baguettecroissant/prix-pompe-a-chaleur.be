    ...
    const steps = [
        {
            ...
            desc: `Décrivez votre projet de chauffage en ligne pour lancer la première étude d'éligibilité aux primes ${isWallonie ? 'wallonnes' : 'bruxelloises'}.`
        },
        {
            icon: UserCheck,
            title: "Visite Technique",
            desc: `Un installateur certifié RESCert de la province de ${city.province_name} se déplace pour le dimensionnement thermique de la PAC.`
        },
        {
            icon: Wrench,
            title: "Installation",
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {steps.map((step, idx) => (
                            <div key={idx} className="relative flex flex-col items-center text-center group">
                                <div className="w-16 h-16 bg-white border-2 border-teal-100 rounded-full flex items-center justify-center mb-4 z-10 group-hover:border-teal-500 group-hover:bg-teal-50 transition-colors">
